...
//            }
    ...
    public String getCategoryActivity(Long categoryId, Long activityId) {
...
//              }
    ...
    public String updateCategoryActivity(Long categoryId, Long activityId, Activity activityObject) {
...
//                }
    ...
    public String deleteCategoryActivity(Long categoryId, Long activityId) {
        Optional<Category> category = categoryRepository.findById(categoryId);
        if (category.isPresent()) {
            for (Activity activity : category.get().getActivityList()) {
                if (activity.getId() == activityId) {
